...
const SummaryPageNumber = ({ currentStep }) => {
  ...
  const steps = isSmUp
    ? [
      { label: "Product", path: "/checkout", labelOffset: "ml-4" },
      { label: "Address", path: "/checkout", labelOffset: "ml-4" },
      { label: "Payment", path: "/payment", labelOffset: "" },
      { label: "Summary", path: "/finalSummaryPage", labelOffset: "mr-8" },
    ]
    : [
      { label: "Address", path: "/checkout", labelOffset: "ml-4" },
      { label: "Payment", path: "/payment", labelOffset: "" },
          ...
          return (
            <React.Fragment key={index}>
              ...
              <div
                ...
                className={`cursor-pointer w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium
                  ${status === "completed"
              ...
              {index < steps.length - 1 && (
                <div
                  className={`h-[2px] w-10 md:w-20 ${status === "completed"
                      ? "bg-secondaryLite"
                      : status === "current"
                        ? "bg-mutedText"
                        : "bg-gray-300"
